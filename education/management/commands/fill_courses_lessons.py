            ...
            "Django для начинающих": [
                {
                    ...
                    "content": "Установка, создание первого проекта, структура папок.",
                },
                {
                    "title": "Модели и базы данных",
                    "content": "ORM, миграции, работа с PostgreSQL.",
                },
                {
                    "title": "Контроллеры и маршруты",
                    "content": "Создание views, настройка urlpatterns.",
                },
                {
                    "title": "Шаблоны и статика",
                    "content": "Django Templating Engine, CSS, JS подключение.",
                },
                {
                    "title": "Формы и валидация",
                    "content": "Создание форм, обработка данных пользователя.",
                },
            ],
            "Django REST Framework (DRF)": [
                {
                    "title": "Что такое REST API?",
                    "content": "Принципы REST, архитектура API.",
                },
                {
                    "title": "Сериализаторы",
                    "content": "ModelSerializer, валидация, вложенные данные.",
                },
                {
                    "title": "ViewSets и роутеры",
                    "content": "ModelViewSet, DefaultRouter, кастомные действия.",
                },
                {
                    "title": "Аутентификация и права",
                    "content": "TokenAuthentication, JWT, permission classes.",
                },
                {
                    "title": "Фильтрация и пагинация",
                    "content": "Filtering, sorting, pagination.",
                },
            ],
            "React + Django интеграция": [
                {
                    "title": "Настройка проекта",
                    "content": "Django + React в одном проекте.",
                },
                {
                    "title": "API подключение",
                    "content": "Axios, fetch, CORS настройка.",
                },
                {
                    "title": "Состояние приложения",
                    "content": "Redux, контекст, работа с данными.",
                },
            ],
            "Асинхронный Django с Channels": [
                {
                    "title": "WebSocket основы",
                    "content": "Отличие от HTTP, установка Channels.",
                },
                {
                    "title": "Создание чата",
                    "content": "Комнаты, уведомления, broadcasting.",
                },
            ],
            "Деплой Django проектов": [
                {
                    "title": "Docker контейнеризация",
                    "content": "Dockerfile, docker-compose.",
                },
                {
                    "title": "Настройка Nginx",
                    "content": "Проксирование, статика, media.",
                },
                {
                    "title": "Деплой на сервер",
                    "content": "DigitalOcean, AWS, GitHub Actions.",
                },
            ],
        }
        ...
        for course in created_courses:
            if course.title in lessons_data:
                for lesson_data in lessons_data[course.title]:
                    ...
                    self.stdout.write(
                        self.style.SUCCESS(
                            f"Создан урок: {lesson.title} курс: {course.title})"
                        )
                    )

        self.stdout.write(self.style.SUCCESS("=" * 50))
        self.stdout.write(
            self.style.SUCCESS(f"ГОТОВО! Создано курсов: {len(created_courses)}")
        )
